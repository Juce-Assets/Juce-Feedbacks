...
{
    [FeedbackIdentifier("Color Alpha", "Renderer Material/")]
    public class RendererMaterialColorAlphaFeedback : Feedback
    {
        [Header("Target")]
        ...
        protected override void OnCreate()
        {
            ...
            rendererMaterialPropertyElement.MaterialPropertyType = MaterialPropertyType.Color;
