...
namespace Juce.Feedbacks
{
    ...
    public class SpriteRendererColorAlphaFeedback : Feedback
    {
        ...
        public override ExecuteResult OnExecute(FlowContext context, SequenceTween sequenceTween)
        {
            ...
            Tween.Tween progressTween = target.TweenColorAlpha(value.EndValue, timing.Duration);
            sequenceTween.Append(target.TweenColorAlpha(value.EndValue, timing.Duration));
