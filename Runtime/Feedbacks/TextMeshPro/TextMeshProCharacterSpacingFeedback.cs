...
{
    [FeedbackIdentifier("Character Spacing", "TextMeshPro/")]
    public class TextMeshProCharacterSpacingFeedback : Feedback
    {
        ...
        public override ExecuteResult OnExecute(FlowContext context, SequenceTween sequenceTween)
        {
            ...
            {
                sequenceTween.Append(target.TweenCharacterSpacing(value.StartValue, 0.0f));
            }

            Tween.Tween progressTween = target.TweenCharacterSpacing(value.EndValue, duration);
