...
{
    [FeedbackIdentifier("Line Spacing", "TextMeshPro/")]
    public class TextMeshProLineSpacingFeedback : Feedback
    {
        ...
        public override ExecuteResult OnExecute(FlowContext context, SequenceTween sequenceTween)
        {
            ...
            {
                sequenceTween.Append(target.TweenLineSpacing(value.StartValue, 0.0f));
            }

            Tween.Tween progressTween = target.TweenLineSpacing(value.EndValue, duration);
