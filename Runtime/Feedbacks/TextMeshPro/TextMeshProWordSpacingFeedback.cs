...
{
    [FeedbackIdentifier("Word Spacing", "TextMeshPro/")]
    public class TextMeshProWordSpacingFeedback : Feedback
    {
        ...
        public override ExecuteResult OnExecute(FlowContext context, SequenceTween sequenceTween)
        {
            ...
            {
                sequenceTween.Append(target.TweenWordSpacing(value.StartValue, 0.0f));
            }

            Tween.Tween progressTween = target.TweenWordSpacing(value.EndValue, duration);
